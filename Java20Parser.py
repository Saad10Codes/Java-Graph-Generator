# Generated from Java20Parser.g4 by ANTLR 4.9.3
# encoding: utf-8
from antlr4 import *
...
class Java20Parser ( Parser ):
    ...
    class CoitContext(ParserRuleContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            localctx.parent = self._ctx  # Set parent context
            super().enterRule(localctx, ruleIndex, state)
    ...
    def moduleDirective(self):
        ...
        try:
            ...
            if token in [Java20Parser.REQUIRES]:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                while _la==Java20Parser.TRANSITIVE or _la==Java20Parser.STATIC:
                    self.state = 833
    ...
    def result(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [Java20Parser.BOOLEAN, Java20Parser.BYTE, Java20Parser.CHAR, Java20Parser.DOUBLE, Java20Parser.FLOAT, Java20Parser.INT, Java20Parser.LONG, Java20Parser.SHORT, Java20Parser.Identifier]:
                self.enterOuterAlt(localctx, 1)
                self.state = 1141
                self.unannType()
                pass
    ...
    def methodDeclarator(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << Java20Parser.BOOLEAN) | (1 << Java20Parser.BYTE) | (1 << Java20Parser.CHAR) | (1 << Java20Parser.DOUBLE) | (1 << Java20Parser.FINAL) | (1 << Java20Parser.FLOAT) | (1 << Java20Parser.INT) | (1 << Java20Parser.LONG) | (1 << Java20Parser.SHORT))) != 0) or _la==Java20Parser.AT or _la==Java20Parser.Identifier:
                self.state = 1152
    ...
    def enumBody(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if _la==Java20Parser.AT or _la==Java20Parser.Identifier:
                self.state = 1322
    ...
    def recordHeader(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << Java20Parser.BOOLEAN) | (1 << Java20Parser.BYTE) | (1 << Java20Parser.CHAR) | (1 << Java20Parser.DOUBLE) | (1 << Java20Parser.FLOAT) | (1 << Java20Parser.INT) | (1 << Java20Parser.LONG) | (1 << Java20Parser.SHORT))) != 0) or _la==Java20Parser.AT or _la==Java20Parser.Identifier:
                self.state = 1385
    ...
    def blockStatements(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << Java20Parser.NONSEALED) | (1 << Java20Parser.RECORD) | (1 << Java20Parser.SEALED) | (1 << Java20Parser.VAR) | (1 << Java20Parser.YIELD) | (1 << Java20Parser.ABSTRACT) | (1 << Java20Parser.ASSERT) | (1 << Java20Parser.BOOLEAN) | (1 << Java20Parser.BREAK) | (1 << Java20Parser.BYTE) | (1 << Java20Parser.CHAR) | (1 << Java20Parser.CLASS) | (1 << Java20Parser.CONTINUE) | (1 << Java20Parser.DO) | (1 << Java20Parser.DOUBLE) | (1 << Java20Parser.ENUM) | (1 << Java20Parser.FINAL) | (1 << Java20Parser.FLOAT) | (1 << Java20Parser.FOR) | (1 << Java20Parser.IF) | (1 << Java20Parser.INT) | (1 << Java20Parser.INTERFACE) | (1 << Java20Parser.LONG) | (1 << Java20Parser.NEW) | (1 << Java20Parser.PRIVATE) | (1 << Java20Parser.PROTECTED) | (1 << Java20Parser.PUBLIC) | (1 << Java20Parser.RETURN) | (1 << Java20Parser.SHORT) | (1 << Java20Parser.STATIC) | (1 << Java20Parser.STRICTFP) | (1 << Java20Parser.SUPER) | (1 << Java20Parser.SWITCH) | (1 << Java20Parser.SYNCHRONIZED) | (1 << Java20Parser.THIS) | (1 << Java20Parser.THROW))) != 0) or ((((_la - 64)) & ~0x3f) == 0 and ((1 << (_la - 64)) & ((1 << (Java20Parser.TRY - 64)) | (1 << (Java20Parser.VOID - 64)) | (1 << (Java20Parser.WHILE - 64)) | (1 << (Java20Parser.IntegerLiteral - 64)) | (1 << (Java20Parser.FloatingPointLiteral - 64)) | (1 << (Java20Parser.BooleanLiteral - 64)) | (1 << (Java20Parser.CharacterLiteral - 64)) | (1 << (Java20Parser.StringLiteral - 64)) | (1 << (Java20Parser.TextBlock - 64)) | (1 << (Java20Parser.NullLiteral - 64)) | (1 << (Java20Parser.LPAREN - 64)) | (1 << (Java20Parser.LBRACE - 64)) | (1 << (Java20Parser.SEMI - 64)) | (1 << (Java20Parser.AT - 64)) | (1 << (Java20Parser.INC - 64)) | (1 << (Java20Parser.DEC - 64)) | (1 << (Java20Parser.Identifier - 64)))) != 0):
                self.state = 1679
                self.blockStatement()
                self.state = 1684
                self._errHandler.sync(self)
    ...
    def localVariableType(self):
        ...
        try:
            ...
            if token in [Java20Parser.BOOLEAN, Java20Parser.BYTE, Java20Parser.CHAR, Java20Parser.DOUBLE, Java20Parser.FLOAT, Java20Parser.INT, Java20Parser.LONG, Java20Parser.SHORT, Java20Parser.Identifier]:
                ...
                self.unannType()
                pass
            elif token in [Java20Parser.VAR]:
                self.enterOuterAlt(localctx, 2)
                self.state = 1705
    ...
    def statementWithoutTrailingSubstatement(self):
        ...
        try:
            ...
            if token in [Java20Parser.LBRACE]:
                ...
                pass
            elif token in [Java20Parser.BOOLEAN, Java20Parser.BYTE, Java20Parser.CHAR, Java20Parser.DOUBLE, Java20Parser.FLOAT, Java20Parser.INT, Java20Parser.LONG, Java20Parser.NEW, Java20Parser.SHORT, Java20Parser.SUPER, Java20Parser.THIS, Java20Parser.VOID, Java20Parser.IntegerLiteral, Java20Parser.FloatingPointLiteral, Java20Parser.BooleanLiteral, Java20Parser.CharacterLiteral, Java20Parser.StringLiteral, Java20Parser.TextBlock, Java20Parser.NullLiteral, Java20Parser.LPAREN, Java20Parser.AT, Java20Parser.INC, Java20Parser.DEC, Java20Parser.Identifier]:
                self.enterOuterAlt(localctx, 3)
                self.state = 1728
                self.expressionStatement()
                pass
            elif token in [Java20Parser.ASSERT]:
                self.enterOuterAlt(localctx, 4)
                self.state = 1729
                self.assertStatement()
                pass
            elif token in [Java20Parser.SWITCH]:
                self.enterOuterAlt(localctx, 5)
                self.state = 1730
                self.switchStatement()
                pass
            elif token in [Java20Parser.DO]:
                self.enterOuterAlt(localctx, 6)
                self.state = 1731
                self.doStatement()
                pass
            elif token in [Java20Parser.BREAK]:
                self.enterOuterAlt(localctx, 7)
                self.state = 1732
                self.breakStatement()
                pass
            elif token in [Java20Parser.CONTINUE]:
                self.enterOuterAlt(localctx, 8)
                self.state = 1733
                self.continueStatement()
                pass
            elif token in [Java20Parser.RETURN]:
                self.enterOuterAlt(localctx, 9)
                self.state = 1734
                ...
                self.throwStatement()
                pass
            elif token in [Java20Parser.TRY]:
                self.enterOuterAlt(localctx, 12)
                self.state = 1737
                self.tryStatement()
                pass
            elif token in [Java20Parser.YIELD]:
    ...
    def lambdaParameters(self):
        ...
        try:
            ...
            if token in [Java20Parser.LPAREN]:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << Java20Parser.VAR) | (1 << Java20Parser.BOOLEAN) | (1 << Java20Parser.BYTE) | (1 << Java20Parser.CHAR) | (1 << Java20Parser.DOUBLE) | (1 << Java20Parser.FINAL) | (1 << Java20Parser.FLOAT) | (1 << Java20Parser.INT) | (1 << Java20Parser.LONG) | (1 << Java20Parser.SHORT))) != 0) or _la==Java20Parser.AT or _la==Java20Parser.Identifier:
                    self.state = 2892
                ...
                self.match(Java20Parser.RPAREN)
                pass
            elif token in [Java20Parser.Identifier]:
                self.enterOuterAlt(localctx, 2)
                self.state = 2896
                self.match(Java20Parser.Identifier)
                pass
